...
-- Create product_quota_tracking table
...
-- Initialize daily quota tracking for existing users
...
-- Initialize monthly quota tracking for existing users
INSERT INTO product_quota_tracking (
    user_id, 
    quota_type, 
    quota_period_start, 
...
-- Initialize total quota tracking for existing users
INSERT INTO product_quota_tracking (
    user_id, 
    quota_type, 
    quota_period_start, 
