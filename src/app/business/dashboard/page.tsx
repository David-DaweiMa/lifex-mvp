...
// Export additional helper for profile page integration
export const BusinessDashboardLink: React.FC<{ currentUser: any }> = ({ currentUser }) => {
  const isBusinessUser = currentUser && 
    ['free_business', 'professional_business', 'enterprise_business'].includes(currentUser.user_type);
  ...
  return (
    <button
      ...
      className="w-full p-4 rounded-xl border transition-all hover:scale-105 group"
      style={{
    ...
    >
      <div className="flex items-center">
        ...
        <div className="text-left flex-1">
          <h3 className="font-semibold" style={{ color: darkTheme.text.primary }}>
            Business Dashboard
          </h3>
