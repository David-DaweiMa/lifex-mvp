          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-1">
              <h3 className="font-semibold mb-4 flex items-center gap-2 text-base md:text-lg" style={{ color: darkTheme.text.primary }}>
                <TrendingUp size={20} style={{ color: darkTheme.neon.green }} />
                Top Trending
              </h3>
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center justify-between mb-4">
                ...
                <button 
                  className="px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm font-medium flex items-center gap-2"
              ...
              <div className="space-y-4">
                {getFilteredTrendingPosts().map((post) => (
                  <div 
                    key={post.id}
