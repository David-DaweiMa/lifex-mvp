...
:root {
  ...
  --theme-bg-card: #1A1625;
  --theme-bg-glass: #8B5CF620;
  --theme-bg-overlay: #0F0B1ACC;
  --theme-text-primary: #FFFFFF;
  --theme-text-secondary: #22C55E;
  --theme-text-muted: #805AD5;
  --theme-text-inverse: #0F0B1A;
  --theme-border: #374151;
...
@layer components {
  .btn-primary {
    @apply bg-lifex-purple text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition-all duration-200;
  }
